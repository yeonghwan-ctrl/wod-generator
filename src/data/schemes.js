...
export const SCHEMES = {
  ...
  strength: [
    ...
    { sets: 3, reps: 5, percent: 65, note: 'deload' },
  ],
  ...
  strengthUpper: [
    ...
    { sets: 3, reps: 5, percent: 60, note: 'deload' },
  ],
  ...
  olympic: [
    ...
    { sets: 4, reps: 2, percent: 65, note: 'deload' },
  ],
  ...
  technique: [
    ...
    { sets: 4, reps: 2, percent: 70, note: 'deload' },
  ],
  ...
  pull: [
    ...
    { sets: 3, reps: 3, percent: 85, note: 'deload' },
  ],
  ...
  highPull: [
    ...
    { sets: 3, reps: 3, percent: 70, note: 'deload' },
  ],
  ...
  deadliftVariant: [
    ...
    { sets: 3, reps: 4, percent: 90, note: 'deload' },
  ],
